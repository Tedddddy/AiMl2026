...
\begin{frame}{Surjective bounded morphism}
	...
	\end{itemize}
	    ...
	    {\transparent{0.3}
   		...
   		2nd cond: for all $1 \le i \le k$, for all $(\alpha,\beta) \in X \times X$ and all $U \in \tau_i((\alpha,\beta)): g(U) \in \sigma_i(g(\alpha,\beta))$ \newline
...
\begin{frame}{Surjective bounded morphism}
		...
		{\transparent{0.3}
		Note: $\tau(x,y) = \{U \mid \exists k,j \in \mathbb{N}: U_k(x) \times U_j(y) \subseteq U\}, \sigma(x) = \{U \mid R(x) \subseteq U\}$\newline
		3rd cond: for all $1 \le i \le k$, for all $(\alpha,\beta) \in X \times X$ and all $V \in \sigma_i(g(\alpha,\beta))$, there exists $U \in \tau_i(\alpha,\beta)$ such that $g(U) \subseteq V$ 
		}
\end{frame}
